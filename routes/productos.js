...
//Servicio renderizar vista del forulario de añadir productos
router.get('/nuevo', autenticacion, (req, res) => {
    res.render('admin_productos_form');
});

//Servicio renderizar vista del formulario de editar producto
...
//Servicio para añadir productos
...
// Servicio para modificar productos
